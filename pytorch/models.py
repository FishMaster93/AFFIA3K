...
class Cnn6(nn.Module):
    def __init__(self, sample_rate, window_size, hop_size, mel_bins, fmin,
        ...
        # add Linear (label) for merging features
        self.conv_block1 = ConvBlock5x5(in_channels=1, out_channels=64)
        self.conv_block2 = ConvBlock5x5(in_channels=64, out_channels=128) # conv2 64 + output dim of linear layer (label)
    ...
    def forward(self, input, mixup_lambda=None):
        ...
        # merge features
        # video_e = l1(video_input)
        # torch.cat([video_e, x], dim=-1)
